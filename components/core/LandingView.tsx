      ...
      <div className="hidden md:block bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 md:px-12 h-10 flex justify-between items-center text-[11px] font-medium text-slate-500">
          <div className="flex gap-6">
            ...
            <Link to="/admin/login" className="hover:text-[#E30613] cursor-pointer transition-colors">银监会</Link>
          </div>
          <div className="flex gap-6">
        ...
        <div className="flex items-center gap-8 lg:gap-12">
          ...
          <div className="flex items-center gap-8">
            {['首页', '服务中心', '开户申请', '进入平台'].map(item => (
              <span 
                key={item} 
                onClick={item === '开户申请' ? onQuickOpen : item === '进入平台' ? onEnter : item === '服务中心' ? () => navigate('/app-download') : undefined}
