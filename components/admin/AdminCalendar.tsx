          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-industrial-100">
              {loading ? (
                ...
                <tr><td colSpan={5} className="px-6 py-8 text-center text-xs font-bold text-industrial-400">暂无日历事件</td></tr>
              ) : events.map((event) => (
          ...
          >
            ...
            <form onSubmit={handleCreateEvent} className="space-y-4">
              ...
              <div>
                ...
                <input type="text" value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} className="industrial-input" />
              </div>
