...
export const LazyImage = ({
  ...
  if (hasError) {
    return (
      <div
        className="bg-gray-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-500 text-sm min-h-[100px]"
        style={{ width, height }}
        role="img"
      ...
      >
        ...
        <span className="text-xs text-gray-400 mt-1">{alt}</span>
      </div>
    );
  }
