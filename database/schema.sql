...
CREATE INDEX idx_trades_user_market_status ON public.trades(user_id, market_type, status);
CREATE INDEX idx_admin_logs_operate_type_time ON public.admin_operation_logs(operate_type, created_at);
